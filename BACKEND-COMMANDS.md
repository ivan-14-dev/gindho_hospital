...
### Notification Service (Port: 8104)
```bash
# Build
...
### Authorization Service (Port: 8089)
```bash
# Build
...
docker exec -it gindho-kafka kafka-topics --list --bootstrap-server localhost:9092

# Create topic
docker exec -it gindho-kafka kafka-topics --create --topic patient-events --bootstrap-server localhost:9092 --partitions 3 --replication-factor 1

# Describe topic
docker exec -it gindho-kafka kafka-topics --describe --topic patient-events --bootstrap-server localhost:9092

# Delete topic
docker exec -it gindho-kafka kafka-topics --delete --topic patient-events --bootstrap-server localhost:9092
```

### Kafka Producer/Consumer Testing
```bash
# Produce messages
docker exec -it gindho-kafka kafka-console-producer --topic patient-events --bootstrap-server localhost:9092

# Consume messages
docker exec -it gindho-kafka kafka-console-consumer --topic patient-events --from-beginning --bootstrap-server localhost:9092

# Consume with specific group
docker exec -it gindho-kafka kafka-console-consumer --topic patient-events --group test-group --bootstrap-server localhost:9092
```
...
# Then inside pod:
wget -O- http://patient-service:8081/actuator/health
...
|---------|------|-----------|
| API Gateway (Kong) | 8000 | apigateway |
| Identity Service | 8080 | identity |
| Patient Service | 8081 | patient |
| Appointment Service | 8082 | appointment |
| Medical Record Service | 8083 | emr |
| Admission Service | 8084 | admission |
| Emergency Service | 8085 | emergency |
| Ward Service | 8086 | ward |
| Bed Service | 8087 | bed |
| Round Service | 8088 | round |
| Surgery Service | 8089 | surgery |
| Prescription Service | 8090 | prescription |
| Pharmacy Service | 8091 | pharmacy |
| Laboratory Service | 8092 | laboratory |
| Imaging Service | 8093 | imaging |
| Billing Service | 8094 | billing |
| Insurance Service | 8095 | insurance |
| Payment Service | 8096 | payment |
| Inventory Service | 8097 | inventory |
| Procurement Service | 8098 | procurement |
| Asset Service | 8099 | asset |
| Ambulance Service | 8100 | ambulance |
| HR Service | 8101 | hr |
| Scheduling Service | 8102 | scheduling |
| Event Service | 8103 | event |
| Notification Service | 8104 | notification |
| Reporting Service | 8105 | reporting |
| Audit Service | 8106 | audit |
| Authorization Service | 8089 | authorization |
