...
//
// IMPORTANT (FR)
// Filtre JWT : vérifie l’en-tête Authorization: Bearer <token> et charge le user via CustomUserDetailsService.
// Si ce filtre ne met pas SecurityContext correctement, les règles SecurityConfig (ROLE_*) ne s’appliqueront pas.
//
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        boolean isAnonymous = currentAuth == null || currentAuth instanceof AnonymousAuthenticationToken;
