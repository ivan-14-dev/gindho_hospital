...
public class ApiController {
    ...
    public ResponseEntity<java.util.List<?>> listAuditLogs(
    ...
    public ResponseEntity<java.util.List<?>> adminGetAllUsers() {
        return ResponseEntity.ok(java.util.List.of());
    }

    @PutMapping("/admin/users/{id}/role")
    public ResponseEntity<?> adminUpdateRole(@PathVariable Long id, @RequestBody Object request) {
        return ResponseEntity.ok(request);
    }

    @PutMapping("/admin/users/{id}/active")
    public ResponseEntity<?> adminUpdateActive(@PathVariable Long id, @RequestBody Object request) {
        return ResponseEntity.ok(request);
    }

    @PutMapping("/admin/users/{id}/permissions")
    public ResponseEntity<?> adminUpdatePermissions(@PathVariable Long id, @RequestBody Object request) {
        return ResponseEntity.ok(request);
    }

    // ===== ADMIN ROLE TEMPLATES =====
    @PostMapping("/admin/role-templates")
    public ResponseEntity<?> adminCreateRoleTemplate(@RequestBody Object request) {
        return ResponseEntity.ok(request);
    }

    @GetMapping("/admin/role-templates")
    public ResponseEntity<java.util.List<?>> adminListRoleTemplates() {
        return ResponseEntity.ok(java.util.List.of());
    }

    @PutMapping("/admin/role-templates/{templateId}/apply/{userId}")
    public ResponseEntity<?> adminApplyTemplate(@PathVariable Long templateId, @PathVariable Long userId) {
        return ResponseEntity.ok(java.util.Map.of("templateId", templateId, "userId", userId));
    }

    // ===== ADMIN PERMISSIONS =====
    @GetMapping("/admin/permissions/catalog")
    public ResponseEntity<java.util.List<String>> adminPermissionsCatalog() {
        return ResponseEntity.ok(java.util.List.of("PATIENTS:READ", "PATIENTS:WRITE", "PATIENTS:DELETE"));
    }

    // ===== AUTH AUTHORITIES =====
    @GetMapping("/auth/me-authorities")
    public ResponseEntity<java.util.List<String>> meAuthorities() {
        return ResponseEntity.ok(java.util.List.of("ROLE_USER"));
    }
